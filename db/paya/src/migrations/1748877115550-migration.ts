...
export class Migration1748877115550 implements MigrationInterface {
  public name = 'Migration1748877115550';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "tsys_fiu_file_variant" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "file_id" uuid NOT NULL, "downloader_user_name" character varying, "uploader_user_name" character varying, "variant_type" "public"."tsys_fiu_file_variant_variant_type_enum" NOT NULL, "s3_directory_path" character varying NOT NULL, "contents_hash" character varying NOT NULL, "uploader_ip" inet, "downloaded_at" TIMESTAMP WITH TIME ZONE, "downloader_ip" inet, "modified_at" TIMESTAMP WITH TIME ZONE, CONSTRAINT "UQ_a8940082417c5f8de406386c523" UNIQUE ("file_id", "variant_type"), CONSTRAINT "PK_5f5ac07e56d0cc1c3286e114717" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
