...
export class Migration1748468987012 implements MigrationInterface {
  public name = 'Migration1748468987012';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "tsys_fiu_file_variant" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "variant_type" "public"."tsys_fiu_file_variant_variant_type_enum" NOT NULL, "s3_directory_path" character varying NOT NULL, "contents_hash" character varying NOT NULL, "uploader_ip" inet, "downloaded_at" TIMESTAMP WITH TIME ZONE, "downloader_ip" inet, "modified_at" TIMESTAMP WITH TIME ZONE, "file_id" uuid, CONSTRAINT "PK_5f5ac07e56d0cc1c3286e114717" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
