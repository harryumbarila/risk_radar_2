...
@Entity('tbl_risk_rule_white_list_mcc_audit_log', { schema: 'dbo', database: 'RiskRadar' })
export class RiskRuleWhiteListMccAuditLogEntity {
  @ApiProperty({
  ...
  @Column({ name: 'MCC', type: 'varchar', length: 4, nullable: true })
  MCC?: string;
