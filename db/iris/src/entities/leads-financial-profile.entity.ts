...
export class LeadsFinancialProfileEntity {
  ...
  @Column({ name: 'AmexAvgMonthlyVolume', type: 'decimal', precision: 20, scale: 4, nullable: true })
  ...
  @Column({ name: 'StoreFrontSwiped', type: 'decimal', precision: 20, scale: 4, nullable: true })
  public storeFrontSwiped: number | null;

  @Column({ name: 'Internet', type: 'decimal', precision: 20, scale: 4, nullable: true })
  public internet: number | null;

  @Column({ name: 'MOTOMailTelephoneOrder', type: 'decimal', precision: 20, scale: 4, nullable: true })
  public motoMailTelephoneOrder: number | null;

  @Column({ name: 'Keyed', type: 'decimal', precision: 20, scale: 4, nullable: true })
  public keyed: number | null;

  @Column({ name: 'VMCDAvgMonthlyVolume', type: 'decimal', precision: 20, scale: 4, nullable: true })
  public vmcdAvgMonthlyVolume: number | null;

  @Column({ name: 'VMCDAverageTicket', type: 'decimal', precision: 20, scale: 4, nullable: true })
  public vmcdAverageTicket: number | null;

  @Column({ name: 'HighTicket', type: 'decimal', precision: 20, scale: 4, nullable: true })
  public highTicket: number | null;

  @Column({ name: 'SeasonalMerchant', type: 'bit', nullable: true })
  public seasonalMerchant: boolean | null;

  @Column({ name: 'IfYesHighVolMonths', type: 'varchar', length: 100, nullable: true })
  ...
  @Column({ name: 'SeasonalVolume', type: 'decimal', precision: 20, scale: 4, nullable: true })
  public seasonalVolume: number | null;

  @Column({ name: 'CreditBankName', type: 'varchar', length: 100, nullable: true })
  public creditBankName: string | null;

  @Column({ name: 'CreditRoutingNumber', type: 'varchar', length: 25, nullable: true })
  public creditRoutingNumber: string | null;

  @Column({ name: 'CreditAccountType', type: 'varchar', length: 100, nullable: true })
  public creditAccountType: string | null;

  @Column({ name: 'NameOnCreditAccount', type: 'varchar', length: 100, nullable: true })
  public nameOnCreditAccount: string | null;

  @Column({ name: 'DebitRoutingNumber', type: 'varchar', length: 50, nullable: true })
  public debitRoutingNumber: string | null;

  @Column({ name: 'DebitBankName', type: 'varchar', length: 75, nullable: true })
  public debitBankName: string | null;

  @Column({ name: 'DebitAccountType', type: 'varchar', length: 100, nullable: true })
  ...
  @Column({ name: 'IfYesWhatDate', type: 'varchar', length: 75, nullable: true })
  ...
  @Column({ name: 'AnnualAmexVolume', type: 'varchar', length: 50, nullable: true })
  ...
  @Column({ name: 'DiscountMethod', type: 'varchar', length: 100, nullable: true })
  public discountMethod: string | null;

  @Column({ name: 'CreditAccountOwnership', type: 'varchar', length: 100, nullable: true })
  public creditAccountOwnership: string | null;

  @Column({ name: 'NameOnDebitAccount', type: 'varchar', length: 100, nullable: true })
  public nameOnDebitAccount: string | null;

  @Column({ name: 'DebitAccountOwnership', type: 'varchar', length: 100, nullable: true })
  public debitAccountOwnership: string | null;

  @Column({ name: 'AnnualCashCreditVol', type: 'varchar', length: 50, nullable: true })
  ...
  @Column({ name: 'NextDayFunding', type: 'varchar', length: 100, nullable: true })
  public nextDayFunding: string | null;

  @Column({ name: 'AnnualMCVisaVolume', type: 'decimal', precision: 20, scale: 4, nullable: true })
  public annualMcVisaVolume: number | null;

  @Column({ name: 'AnnualDiscoverPPVolume', type: 'decimal', precision: 20, scale: 4, nullable: true })
  public annualDiscoverPpVolume: number | null;

  @Column({ name: 'AnnualWEXVolume', type: 'decimal', precision: 20, scale: 4, nullable: true })
  public annualWexVolume: number | null;

  @Column({ name: 'AnnualVoyagerVolume', type: 'decimal', precision: 20, scale: 4, nullable: true })
  ...
  @Column({ name: 'DebitBankContact', type: 'varchar', length: 100, nullable: true })
