...
import { TaskHeader } from '@/ui/common/task-header';
import { Drag } from '@/ui/js/drag';
        ...
        <div className="swim-lane flex flex-col gap-5.5">
          ...
          >
            <div>
              ...
              <div className="flex flex-col gap-2">
                <label
                  htmlFor="taskCheckbox1"
                  className="cursor-pointer"
                  aria-label="Task 1 checkbox"
                >
                ...
                <label
                  htmlFor="taskCheckbox3"
                  className="cursor-pointer"
                  aria-label="Task 3 checkbox"
                >
                  <div className="relative flex items-center pt-0.5">
                    <input
                      type="checkbox"
          ...
          >
            <div>
              ...
              <div className="flex flex-col gap-2">
                <label
                  htmlFor="taskCheckbox4"
                  className="cursor-pointer"
                  aria-label="Task 4 checkbox"
                >
                  <div className="relative flex items-center pt-0.5">
                    <input
                      type="checkbox"
                ...
                <label
                  htmlFor="taskCheckbox5"
                  className="cursor-pointer"
                  aria-label="Task 5 checkbox"
                >
                  <div className="relative flex items-center pt-0.5">
                    <input
                      type="checkbox"
          ...
          >
            <div>
              ...
              <div className="flex flex-col gap-2">
                <label
                  htmlFor="taskCheckbox6"
                  className="cursor-pointer"
                  aria-label="Task 6 checkbox"
                >
                  <div className="relative flex items-center pt-0.5">
                    <input
                      type="checkbox"
        ...
        <div className="swim-lane flex flex-col gap-5.5">
          ...
          >
            <div>
              ...
              <div className="flex flex-col gap-2">
                <label
                  htmlFor="taskCheckbox7"
                  className="cursor-pointer"
                  aria-label="Task 7 checkbox"
                >
                  <div className="relative flex items-center pt-0.5">
                    <input
                      type="checkbox"
        ...
        <div className="swim-lane flex flex-col gap-5.5">
          ...
          >
            <div>
              ...
              <div className="flex flex-col gap-2">
                <label
                  htmlFor="taskCheckbox8"
                  className="cursor-pointer"
                  aria-label="Task 8 checkbox"
                >
                  <div className="relative flex items-center pt-0.5">
                    <input
                      type="checkbox"
                ...
                <label
                  htmlFor="taskCheckbox9"
                  className="cursor-pointer"
                  aria-label="Task 9 checkbox"
                >
                  <div className="relative flex items-center pt-0.5">
                    <input
                      type="checkbox"
