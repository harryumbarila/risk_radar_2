...
import { DataStats } from '@/ui/common/data-stats/data-stats';
import { TableTwo } from '@/ui/common/tables/table-two';
import { TopChannels } from '@/ui/common/top-channels';
import { TopContent } from '@/ui/common/top-content';

const MapTwo = dynamic(
  () => import('@/ui/common/maps/map-two').then((m) => m.MapTwo),
  {
    ssr: false,
  }
);
