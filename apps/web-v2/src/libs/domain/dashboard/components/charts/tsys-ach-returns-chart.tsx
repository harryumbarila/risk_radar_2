...
interface TSYSACHReturnsChartProps {
  dateRange?: FilterState;
}

export default function TSYSACHReturnsChart({ dateRange }: TSYSACHReturnsChartProps) {
  ...
  const data = React.useMemo(() => {
    const rawData = generateRuleParticipationData(days, 800, aggregation);
