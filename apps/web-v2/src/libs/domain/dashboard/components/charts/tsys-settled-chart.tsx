...
interface TSYSSettledChartProps {
  dateRange?: FilterState;
}

export default function TSYSSettledChart({ dateRange }: TSYSSettledChartProps) {
  ...
  const data = React.useMemo(() => {
    const rawData = generateRuleParticipationData(days, 1500, aggregation);
