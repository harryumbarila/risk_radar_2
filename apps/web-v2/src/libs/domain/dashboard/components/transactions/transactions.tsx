...
const generateTransactions = (): (MerchantTransaction & { ruleId?: string })[] => {
  ...
  return [
    ...
    // Previous transactions
    {
      ...
      source: dataSources[0] || 'Auth',
      dataSourceIdentifier: generateDataSourceIdentifier(dataSources[0] || 'Auth', tx1Date),
    ...
    } as MerchantTransaction & { ruleId?: string },
    {
      ...
      netDivertBalance: '$0.00',
      source: dataSources[1] || 'Capture',
      dataSourceIdentifier: generateDataSourceIdentifier(dataSources[1] || 'Capture', tx2Date),
      ahRuleApplied: ['AH002'],
    ...
    } as MerchantTransaction & { ruleId?: string },
    {
      ...
      dataSourceIdentifier: generateDataSourceIdentifier(dataSources[2] || 'Settled', tx3Date),
    ...
    } as MerchantTransaction & { ruleId?: string },
    {
      ...
      source: dataSources[0] || 'Auth',
      dataSourceIdentifier: generateDataSourceIdentifier(dataSources[0] || 'Auth', tx5Date),
      ahRuleApplied: ['AH005'],
