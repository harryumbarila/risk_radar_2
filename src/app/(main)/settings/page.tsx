...
import { MdSecurity, MdCategory, MdStore, MdAssessment } from 'react-icons/md';
...
export default function SettingsPage(): React.JSX.Element {
  const modules = [
    ...
    },
    {
      ...
      description: 'Define and manage merchant transaction risk thresholds',
      icon: MdAssessment,
      path: '/settings/merchant-risk-thresholds',
      color: 'brand.600',
    },
  ];
